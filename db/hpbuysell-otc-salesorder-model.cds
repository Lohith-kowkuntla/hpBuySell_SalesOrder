...
entity SalesOrders : managed {
    ...
    key hpSalesOrder                   : String(10);
        ...
        @title              : '{i18n>soHeader.hpNotesToCustomerProcessingInd}'
        @readonly
        hpNotesToCustomerProcessingInd : Boolean default false;
...
entity SalesOrderItems : managed {
    ...
    key lineId                             : String(6);
        ...
        @title              : '{i18n>soItem.salesPriceProcessingInd}'
        @readonly
        salesPriceProcessingInd            : Boolean default false;

        @title              : '{i18n>soItem.salesPriceUnitProcessingInd}'
        @readonly
        salesPriceUnitProcessingInd        : Boolean default false;

        @title              : '{i18n>soItem.specialDealFlagSoProcessingInd}'
        @readonly
        specialDealFlagSoProcessingInd     : Boolean default false;
        ...
        @title              : '{i18n>soItem.hpBacklogNotesProcessingInd}'
        @readonly
        hpBacklogNotesProcessingInd        : Boolean default false;
...
// they live n db/data/*_texts.csv, one row per locale.
// ---------------------------------------------------------------------------
